...
\begin{figure}
\centering
	\includegraphics[width=0.9\textwidth]{img/GeneralFlow.png}
...
Diagramy UML klas i sekwencji przedstawiono kolejno na rysunkach TODO i \ref{fig:sequenceResultCalculator}.

\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{img/sequenceResultCalculator.png}
	\caption{Diagram przepływu w komponecie ResultCalculator.}
	\label{fig:sequenceResultCalculator}
\end{figure}
