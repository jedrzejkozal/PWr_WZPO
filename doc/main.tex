...
Przy konfiguracji systemu rozważano dwie możliwości realizacji. Konfiguracja elementów systemu może odbywać się przez wstrzykiwanie zależności, czyli przekazywanie implementacji interfesjów przez metody buildera, lub przez korzystanie z wartości typy wyliczeniowego do określenia typu obiektu jaki ma być wykorzystany. Pierwsze rozwiązanie ułatwia 
