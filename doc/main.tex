...
TestPlatform jest odpowiedzialny za konfiguracje eksperymentu i stworzenie wszystkich niezbędnych obiektów. Jest to główny komponent, będący punktem wejścia dla użytkownika. Główna logika aplikacji została zawarta w tym komponencie. Pozostałe komponenty zostały oddzielone przez interfejsy.

\subsection{Komponent Dataset}

Dataset odpowiada za nałożenie abstrakcji na zbiory uczące i umożliwia przeprowadzenie analizy zbioru.
